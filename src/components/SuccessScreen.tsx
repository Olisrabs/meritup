...
export default function SuccessScreen({
  ...
  const content = isPartner ? (
    <>
      ...
      <a 
        href={`https://wa.me/2349124870670?text=${encodeURIComponent(`Hi, my name is ${name || 'a partner'}! I just applied to be a MeritUp Partner.`)}`}
        target="_blank"
    ...
    <>
      ...
      <p className="success-sub">
        {isDuplicate
          ...
          : "We'll notify you the moment we launch. In the meantime, refer friends and get paid for everyone who joins through your link!"}
      </p>
